<?php
    ...
    class AcademiaDAO{
        ...
        public function CadastrarAcademia($Academia){

            $url = 'http://localhost:3001/CadastrarAcademia/' 
            . urlencode($Academia->get_id_academia()). '/'
            . urlencode($Academia->get_NM_Academia());
           ...
           if (is_writable($filePath)) {
               file_put_contents($filePath, "CadastroAcademia: " . $url . "\n", FILE_APPEND);
           } else {
        ...
        public function ConsultarIdAcademia(){
            ...
            file_put_contents('C:\Users\bruno\OneDrive\Área de Trabalho\Log_Erro_TCC\Log_Erro_TCC.txt', "URL consulta id academia: " . $url , FILE_APPEND);

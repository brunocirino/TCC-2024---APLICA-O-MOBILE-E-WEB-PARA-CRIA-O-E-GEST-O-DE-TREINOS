<?php
    ...
    // Verifica se a sessão do email está definida
    if(!isset($_SESSION['id'])) {
        // Se não estiver definida, redireciona para a página de login
        die("Você precisa estar logado para criar um treino!. <p><a href=\"login.php\">Entrar</p>");
        ...
        <section id="criarTreinos">
            <div id="cta">
                ...
                <div class="login-botton">
                    <button><a href="CriarTreino.php">Criar Treinos</a></button>
                </div>
            </div>
